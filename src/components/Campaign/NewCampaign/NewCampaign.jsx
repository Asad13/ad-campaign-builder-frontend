...
import stylesNew from "./NewCampaign.module.scss";
...
const NewCampaign = () => {
  ...
  const { statusNewCampaign } = useSelector((state) => state.campaign);
  ...
  const [screen_selection_id, set_screen_selection_id] = useState(null);

  const [drawAreas, setDrawAreas] = useState({ ...initialDrawArea });
  ...
  const [legalFinancialServicesState, setLegalFinancialServicesState] =
    useState({ ...initialSubCategoriesState["C8"] });
  ...
  const [hospitalityEntertainmentState, setHospitalityEntertainmentState] =
    useState({ ...initialSubCategoriesState["C10"] });

  const [placeTypes, setPlaceTypes] = useState([]);

  const [addressesOfOthersOfSameCategory, setAddressesOfOthersOfSameCategory] = useState({});
  ...
  const resetAll = () => {
    ...
    setAutomotiveState({ ...initialSubCategoriesState["C2"] });

    setHealthMedicalState({ ...initialSubCategoriesState["C3"] });

    setHomeGardenState({ ...initialSubCategoriesState["C4"] });

    setTravelTransportationState({
      ...initialSubCategoriesState["C5"],
    });

    setEducationState({ ...initialSubCategoriesState["C6"] });
    setProfessionalServicesGovernmentState({
      ...initialSubCategoriesState["C7"],
    });

    setLegalFinancialServicesState({
      ...initialSubCategoriesState["C8"],
    });
  ...
  if (statusNewCampaign) {
    dispatch(updateStatusNewCampaign());
  ...
  const handleSubmit = (event) => {
    ...
    if (validate()) {
      ...
      dispatch(createCampaign({ formData, token }));
    }
  };
  ...
  return (
    <>
      <Helmet>
        <title>Campaign Builder - New Campaign</title>
      </Helmet>
      {showModal && (
        <CampaignModal
          type="new"
      ...
      <div className={cns(stylesNew.containerNew)}>
        ...
        <div className={cns(styles.innerContainer)}>
          <div className={cns(styles.left)}>
            <h3 className={cns("campaignHeading")}>Create Campaign</h3>
            <form
              method="post"
              autoComplete="off"
              noValidate
            ...
            >
              <div className={cns(styles.card)} id="newCampaign">
                <div className={cns(styles.row)}>
                  <h5 className={cns("campaignSubHeading")}>New Campaign</h5>
                  <a
              ...
              <div
                className={cns(styles.card, stylesNew.screenSelectionCard)}
                id="screenSelection"
              >
                <div className={cns(styles.row)}>
                  ...
                  <div
                    ...
                    className={cns(stylesNew.tabContainer)}
                  >
                    <span
                      {...setAriaControls(
                        "screen-selection",
                ...
                <div>
                  {tab === SCREEN_SELECTION_BY_TARGETS && (
                    ...
                    >
                      ...
                      <div className={cns(stylesNew.right)}>
                        ...
                        <div className={cns(stylesNew.categoryContainer)}>
                          <div className={cns(stylesNew.categoryTop)}>
                            <div className={cns(stylesNew.divider)}>
                              <input
                                type="checkbox"
                                className={cns(
                                  "custom-checkbox",
                          ...
                          <div>
                            {availCategories.map((category) => (
                              <div
                                key={category.value}
                                className={cns(
                                  stylesNew.categoryOuterContainer
                                )}
                              >
                                <div
                                  className={cns(
                                    "custom-checkbox-radio-container",
                                    stylesNew.categoryInnerContainer
                                  )}
                                >
                                  <div
                                    className={cns(
                                      stylesNew.categoryCheckboxContainer
                                    )}
                                    onMouseDown={() => {
                                      if (
                                  ...
                                  <span
                                    className={cns(stylesNew.categoryIcon)}
                                    onClick={(event) => {
                                      event.stopPropagation();
                                      setCategoryOpenState(
                                        (categoryOpenState) => ({
                                ...
                                <div
                                  className={cns(
                                    stylesNew.subcategoryContainer,
                                    {
                                      [stylesNew.showSubcategory]:
                                        categoryOpenState[category.value],
                                    }
                                  )}
                                >
                                  {category?.subcategories.map(
                                    (subcategory) => (
                                      <div
                                        ...
                                        className={cns(
                                          "custom-checkbox-radio-container",
                                          stylesNew.checkboxContainer,
                                          stylesNew.subCheckboxContainer
                                        )}
                                      >
                                        <input
                                          type="checkbox"
                  ...
                  {tab === SCREEN_SELECTION_BY_RADIUS && (
                    <div
                      role="tabpanel"
                      className={cns(stylesNew.radiusContainer)}
                      id={`screen-selection-tabpanel-${SCREEN_SELECTION_BY_RADIUS}`}
                      aria-labelledby={`screen-selection-tab-${SCREEN_SELECTION_BY_RADIUS}`}
                    >
                      <p className={cns("bodyText2", stylesNew.addressHint)}>
                        Enter the address you want at the center of the circle
                      </p>
                      {addresses.length &&
                        addresses.map((addressItem, index) => (
                          <div className={cns(stylesNew.address)} key={index}>
                            <div className={cns(stylesNew.addressRow)}>
                              {window.google && (
                                <div className={cns(stylesNew.addressInput)}>
                                  <Autocomplete
                                    onLoad={(event) => {
                            ...
                            <div className={cns(stylesNew.addressRow)}>
                              <div className={cns(stylesNew.addressSelect)}>
                                <Select
                                  className={cns(stylesNew.select)}
                                  placeholder="Metric"
                              ...
                              <div
                                className={cns(stylesNew.radiusRangeContainer)}
                              >
                                <div
                                  className={cns(stylesNew.radiusRangeWrapper)}
                                >
                                  <span
                                  ...
                                  >
                                    ...
                                    <ReactTooltip
                                      ...
                                      textColor={stylesNew.white}
                                      backgroundColor={
                                        stylesNew.backgroundColor
                                      }
                                    />
                                  </span>
                                </div>
                      ...
                      <button
                        type="button"
                        className={cns("subHeading", stylesNew.btnAddAddress)}
                        onClick={() => {
                  ...
                  {tab === SCREEN_SELECTION_BY_AREA && (
                    ...
                    >
                      <div className={cns(stylesNew.drawContainer)}>
                        <div className={cns(stylesNew.drawHeading)}>
                          <div className={cns(stylesNew.drawInfoIconContainer)}>
                            <InfoIcon />
                          </div>
                          <div>
                            ...
                            <p className={cns(stylesNew.addressHint)}>
              ...
              <div className={cns(styles.card)} id="scheduling">
                ...
                <div>
                  ...
                  <div className={cns(stylesNew.radioContainer)}>
                    <div>
                      <input
                        type="radio"
                      ...
                      >
                        ...
                        <span
                          className={cns("bodyText2", stylesNew.radioLabel)}
                        >
                          Forever
                        </span>
                      </label>
                  ...
                  {values["publish_dates"] === "custom" && (
                    <div className={cns(stylesNew.radioContainer)}>
                      <div>
                        ...
                        <input
                          type="date"
                          className={cns("input", stylesNew.inputDate)}
                          id="publishDates-start"
                          name="start_date"
                          value={values["start_date"]}
                          min={getDate()}
                          disabled={values["publish_dates"] !== "custom"}
                          onChange={handleChange}
                        />
                      </div>
                      <div>
                ...
                <div className={cns(stylesNew.spacing)}>
                  <h6 className={cns("subHeading", "textWithIcon")}>
                  ...
                  {values["weekdays"] === "custom" && (
                    <div className={cns(stylesNew.daysCheckboxContainer)}>
                      {days.map((day) => (
                        <div
                          key={`key-${day}`}
                          className={cns(stylesNew.daysCheckboxWrapper)}
                        >
                          <input
                            type="checkbox"
                ...
                >
                  ...
                  {values["play_times"] === "custom" && (
                    <>
                        ...
                        <div>
                          ...
                          {values.start_times.map((value, index) => (
                            <input
                              ...
                              max="22:59"
                              value={value}
                              disabled={values["play_times"] !== "custom"}
                              onChange={(event) => {
                      ...
                      <div className={cns(stylesNew.rangeBtnContainer)}>
                        <button
                          type="button"
                          className={cns("subHeading", stylesNew.btn)}
                          onClick={() => {
              ...
              <div className={cns(styles.card)} id="budget">
                ...
                <div className={cns(stylesNew.budgetContainer)}>
                  <div className={cns(stylesNew.left)}>
                    <h5 className={cns("campaignSubHeading")}>Budget</h5>
                  </div>
                  <div className={cns(stylesNew.right)}>
                    <div className={cns(stylesNew.budgetFieldsContainer)}>
                      <div className={cns(stylesNew.fieldContainer)}>
                        <label
                          htmlFor="budget"
                          className={cns(
                            "bodyText2",
                            "topLabel",
                            stylesNew.budgetLabel
                          )}
                        >
                          Spend up to
                        </label>
                      ...
                      <div className={cns("bodyText2", stylesNew.separator)}>
                        <span>- or -</span>
                      </div>
                      <div className={cns(stylesNew.fieldContainer)}>
                        <label
              ...
              <div className={cns(styles.card, stylesNew.upload)} id="upload">
                <div className={cns(styles.row)}>
                ...
                <div className={cns(styles.row, stylesNew.uploadDescContainer)}>
                  <h4 className={cns("uploadHeading")}>
                    Have no creatives? We&rsquo;ve got our own ad builder.
                  </h4>
                  <div className={cns(stylesNew.newCreativesContainer)}>
                    <a
                  ...
                  <p className={cns("bodyText1", stylesNew.uploadOr)}>OR</p>
                ...
                <div
                  ...
                  className={cns(
                    stylesNew.tabContainer,
                    stylesNew.uploadtabContainer
                  )}
                >
                  <span
                    className={cns("tabHeading", "tab", {
                ...
                <div>
                  <div className={cns(stylesNew.uploadCreatives)}>
                    <div>
                      <span className={cns(stylesNew.uploadIconContainer)}>
                        <UploadsIcon />
                      </span>
                    </div>
                    <div>
                      <label
                        htmlFor="creatives"
                        className={cns("heading6", stylesNew.uploadLabel)}
                      >
                        Click to upload
                      </label>{" "}
                ...
                <div>
                  {creatives &&
                    ...
                    creatives.map((creative, index) => (
                      <div
                        key={index}
                        className={stylesNew.creativeDisplayContainer}
                      >
                        <div className={stylesNew.creativeIconContainer}>
                          <span
                            className={cns(
                              "iconContainerCircle",
                              stylesNew.creativeIcon
                            )}
                          >
                        ...
                        <div className={stylesNew.creativePrgressbarContainer}>
                          <h6 className={cns("bodyText2")}>
                            {shortenFileName(creative.name)}
                          </h6>
                          <p className={cns("bodyText2")}>{creative.size}</p>
                          <div className={cns(stylesNew.progressContainer)}>
                            <div>
                              <progress
                        ...
                        <div className={stylesNew.creativeStatusContainer}>
                          <div>
                            {creativesProgress[index] === 100 && (
                              <button
                                type="button"
                          ...
                          <div
                            className={cns(
                              stylesNew.creativeFinishedIconContainer
                            )}
                          >
                            <span
                              className={cns(
                                "iconContainerCircle",
                                stylesNew.finishedIcon,
                                {
                                  [stylesNew.creativeFinishedIcon]:
                                    creativesProgress[index] === 100,
                                },
                                {
                                  [stylesNew.creativeLoadingIcon]:
                                    creativesProgress[index] !== 100,
                                }
                              )}
                            >
                ...
                <div className={cns(stylesNew.creativeInfo)}>
                  <span>
                    <InfoIcon />
                  </span>
                  <p>Do not refresh until your file is fully uploaded</p>
                </div>
                <div className={cns(stylesNew.uploadHintContainer)}>
                  <p className={cns("bodyText2")}>
              ...
              <div className={cns(stylesNew.btnContainer)}>
                <button
                  type="submit"
                  className={cns(stylesNew.saveBtn)}
                  onClick={(event) => {
                    status = statuses[0];
                    handleSubmit(event);
                    setCampaignState("saved");
                ...
                <button
                  type="button"
                  className={cns(stylesNew.activateBtn)}
